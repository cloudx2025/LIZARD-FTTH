...
import { MapPin, Cable, Box, Wifi, Settings as SettingsIcon, LogOut, X } from 'lucide-react';
...
type ActiveForm = 'pop' | 'cabo' | 'cto' | 'fibra' | 'settings' | null;
    ...
    <>
      <div className="w-20 bg-slate-900 flex flex-col items-center py-6 space-y-6">
        ...
        <div className="flex flex-col space-y-4">
          <button
            onClick={() => setActiveForm(activeForm === 'settings' ? null : 'settings')}
            className={`p-3 rounded-lg transition ${
              activeForm === 'settings'
